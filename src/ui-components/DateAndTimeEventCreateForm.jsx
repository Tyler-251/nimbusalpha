...
import { createDateAndTimeEvent } from "../graphql/mutations";
const client = generateClient();
export default function DateAndTimeEventCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createDateAndTimeEvent.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "DateAndTimeEventCreateForm")}
      {...rest}
    >
      <TextField
        label="Start date"
