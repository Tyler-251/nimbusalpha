...
import { createDateEvent } from "../graphql/mutations";
const client = generateClient();
export default function DateEventCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createDateEvent.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "DateEventCreateForm")}
      {...rest}
    >
      <TextField
        label="Start date"
